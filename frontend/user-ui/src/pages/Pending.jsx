      ...
      <div className="page-wrap">
        ...
        <main className="my-auto grid gap-7 py-8 md:grid-cols-2 md:items-center md:gap-10 md:py-12">
          ...
          <section className="panel-strong">
            ...
            <h2 className="title-section font-display mt-3">Application received</h2>
            <p className="lead mt-2">
              Your membership is under review. You will be granted access once approved.
            </p>
