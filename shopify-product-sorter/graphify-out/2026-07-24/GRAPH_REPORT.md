...
## Corpus Check
- 64 files · ~91,156 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 585 nodes · 1208 edges · 24 communities (19 shown, 5 thin omitted)
...
Cohesion: 0.10
Nodes (40): app, clientDistPath, __dirname, __dirname, ensureShopifyEnv(), envLoadReport, repoRoot, requireEnv() (+32 more)
...
Cohesion: 0.05
Nodes (86): env, upload, COLUMN_ALIASES, detectMap(), orderMappingCsvColumns(), parseCsv(), parseOrderMappingCsv(), parseTimestamp() (+78 more)
...
- **Why does `env` connect `Database and Uploads` to `Server Startup`, `Shopify Media and Orders`, `Delivery Import Workflows`, `routes/api.js`, `orderMappingShiprocket.js`?**
