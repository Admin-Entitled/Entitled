(function () {
  ...
  function initCollectionFilters() {
    ...
    if (productList) {
      var firstItem = productList.querySelector('.grid__item');
      itemClassName = firstItem ? firstItem.className : 'grid__item three-twelfths small--one-whole medium--one-half medium-large--four-twelfths';
    }
    ...
    function normalizeSizes(product) {
      ...
      (product.variants || []).forEach(function (variant) {
        ...
        [variant.option1, variant.option2, variant.option3, variant.title].forEach(function (value) {
          ...
          if (/^(xxxl|xxl|xl|xs|s|m|l)\b/i.test(normalized)) {
